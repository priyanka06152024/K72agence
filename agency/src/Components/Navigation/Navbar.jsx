    ...
    return (
        <div className='z-4 flex fixed top-0 w-full items-start justify-between'>
            ...
            <div onClick={()=>{
                ...
                className='lg:h-13 h-10 bg-black  relative lg:w-[16vw] w-55'>
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all absolute top-0 h-0 w-full'></div>
                <div className='relative h-full lg:px-12 px-2 flex flex-col justify-center items-end lg:gap-1.5 gap-0.5'>
                    <div className="lg:w-18 w-3 h-0.5  bg-white hover:bg-black"></div>
                    <div className="lg:w-10 w-3 h-0.5 bg-white hover:bg-black"></div>
                </div>
            </div>
        </div>
    )
